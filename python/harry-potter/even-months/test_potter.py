...
def test_given_a_two_identical_books_basket_and_a_third():
    assert buy(["book_A", "book_A", "cicciopappo"]) == 8 + ((8 * 2) * 0.95)


def test_given_a_two_couples_identical_books_basket():
    discount1 = 16 * 0.05
    discount2 = 24 * 0.1
    assert buy(["book_A", "book_A", "book_B", "book_B", "cicciopappo"]) == (16 - discount1) + (24 - discount2)


def test_given_a_three_couples_identical_books_basket():
    discount1 = 24 * 0.1
    discount2 = 24 * 0.1
    assert buy(["book_A", "book_B", "cicciopappo", "book_A", "book_B", "cicciopappo"]) == 2 * (24 - discount2)
